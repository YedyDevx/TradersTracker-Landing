...
const Section2 = () => {
    ...
    return (
        <motion.div
            className="relative w-full max-x-[600px] xl:h-[620px] 2xl:h-[650px] flex flex-col gap-8 py-10 bg-gradient-to-l from-[#dadada] to-white dark:bg-gradient-to-l dark:from-[#0f0f0f] dark:to-[#0f0f0f] overflow-hidden"
